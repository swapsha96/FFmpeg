...
/*
 * Calculate stereo RMS level. Minimum value is about -100 dB for digital silence.
 * The 90 dB  offset is to compensate for the normalized float range and 3 dB is
 * for stereo samples.
 */
                                       ...
                                       float *dst, int nb_samples)
{
    ...
    // prevent denormals from rattling around in there forever (slowing us down).
